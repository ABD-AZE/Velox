...
// Global type table
extern std::unordered_map<std::string, StructEntry> type_table;
...
private:
  ...
  // Helper function for generating unique structure tag names
  ...
  bool validateTypeSpecifier(const Type &type);
