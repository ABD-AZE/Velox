...
int main(void) {
  ...
  // if we converted 34359738368ul (2^35) to an unsigned int its value would be
  // 0 Note: 1073741824u is 2^30
  ...
  // make sure we convert the two branches of a ternary expression to the common
  // type
