...
3. Constants (literals)
    ...
    | Token           | Description                        | Regex                |                  |
    | --------------- | ---------------------------------- | -------------------- | ---------------- |
    | INT\_CONSTANT   | Signed decimal integer (no suffix) | \`0                  | \[1-9]\[0-9]\*\` |
    | UINT\_CONSTANT  | Unsigned decimal integer (u/U)     | `[0-9]+[uU]\b`       |                  |
    | LONG\_CONSTANT  | Long decimal integer (l/L)         | `[0-9]+[lL]\b`       |                  |
    | ULONG\_CONSTANT | Unsigned long (ul/lu, any case)    | \`\[0-9]+(\[lL]\[uU] | \[uU]\[lL])\b\`  |

    3.2 Floating constants
    | Token            | Description                                        | Regex               |                                |                             |
    | ---------------- | -------------------------------------------------- | ------------------- | ------------------------------ | --------------------------- |
    | DOUBLE\_CONSTANT | Floating‑point constant (fraction and/or exponent) | \`(\[0-9]+.\[0-9]\* | .\[0-9]+)(\[eE]\[+-]?\[0-9]+)? | \[0-9]+\[eE]\[+-]?\[0-9]+\` |
